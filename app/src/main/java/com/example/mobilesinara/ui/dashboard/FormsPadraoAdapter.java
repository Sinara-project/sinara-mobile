...
public class FormsPadraoAdapter extends RecyclerView.Adapter<FormsPadraoAdapter.FormsViewHolder> {

    private List<FormularioPadrao> formularios;

    public FormsPadraoAdapter(List<FormularioPadrao> lista) {
        this.formularios = lista;
    }

    @NonNull
    @Override
    public FormsPadraoAdapter.FormsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_formularios, parent, false);
        return new FormsPadraoAdapter.FormsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FormsPadraoAdapter.FormsViewHolder holder, int position) {
        FormularioPadrao formularioAcao = formularios.get(position);
